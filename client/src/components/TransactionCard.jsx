...
function TransactionCard({ transactions, deleteTransaction }) {
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h1 className="text-3xl font-bold text-center text-blue-700 mb-6">All Transactions</h1>
